...
export class Register {
    ...
    private authStore = inject(AuthStore); // inyecta el store
    ...
    onSubmit(): void {
        ...
        this.authService.register(payload).subscribe({
            next: () => {
                ...
                // Guarda el usuario recién registrado
                this.authStore.setRecentlyRegisteredUser({
            ...
            error: (err) => {
                ...
                this.toastStore.error(err.error?.message || 'Error desconocido');
